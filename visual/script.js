...
function agregarAlCarrito(plan) {
  ...
  if (plan.nombre === 'Internet hogar') {
    imagenSeleccionada = document.getElementById('seleccion_img').src;
  } else if (plan.nombre === 'Cable hogar') {
    imagenSeleccionada = document.getElementById('seleccion_img2').src;
  } else {
    // Agrega casos para otras opciones de cable si es necesario
  }
